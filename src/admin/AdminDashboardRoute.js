    ...
    <Routes>
      <Route path="/" element={<AdminLayout />}>
        ...
        <Route
          ...
          element={<CompanyCreditsManagement />}
        />
        <Route path="/settings" element={<Settings />} />
        <Route path="/logout" element={<Logout />} />
        <Route
          path="/user-management/credit-passbook"
          element={<CreditPassBook />}
        />
        <Route
          path="/company-management/credit-passbook"
          element={<CompanyCreditPassBook />}
        />
        <Route
