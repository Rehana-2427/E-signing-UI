...
const Signin = () => {
    ...
    const recipientEmail = location.state?.userEmail || "";
    const { documentId, senderName, documentName } = location.state || {};
    const validationSchema = yup.object().shape({
        userEmail: yup.string().email("Invalid email").required("Email is required"),
        password: yup.string().min(8, "Password must be 8 characters long").required("Password is required")
    });

    const initialValues = { userEmail: recipientEmail, password: "" };
                    ...
                    <Row>
                        <Col md={6}>
                            <div className="p-4">
                                ...
                                <div className="mt-3 text-center">
                                    <p>
                                        New user?{" "}
                                        <Link to="/register" state={{ pass: recipientEmail }}>
                                            Register here
                                        </Link>
                                    </p>
                        ...
                        <Col md={6} className="text-center auth-cover">
                            <div className="pe-3 auth-right">
                                <SocialButtons isLogin={false} routeUrl="/register" googleHandler={() => { }} />
